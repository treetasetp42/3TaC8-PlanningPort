        ...
        public async Task SendPasswordResetEmailAsync(string to, string resetLink)
        {
            ...
            string body = $@"
                <div style='font-family: sans-serif; padding: 20px; text-align: center; color: #333;'>
                    ...
                    <a href='{safeResetLink}' style='display: inline-block; padding: 12px 24px; background-color: #1976d2; color: white; text-decoration: none; border-radius: 8px; font-weight: bold; margin: 20px 0;'>Reset Password</a>
